...
COPY requirements/requirements_backend.txt /app/requirements/requirements_backend.txt
...
RUN pip install --no-cache-dir --upgrade -r requirements/requirements_backend.txt
